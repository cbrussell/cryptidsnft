...
def combine_attributes(frames: Frames, prefix: str):
    ...
    for n in range(0, 1): #0,72
        ...
        if frames.tail_frames:
            ...
            frame.paste(tail, box=(30, 70), mask=tail)
