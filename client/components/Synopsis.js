      ...
      <div className="flex flex-col items-center justify-center sm:px-0 px-6 z-20 py-5   bg-cryptid-5  ">
        <div className="md:pt-30 sm:pt-5">
          ...
          <p className="flex flex-row justify-start selection:bg-cryptid-2 selection:text-gray-800 lg:px-44 md:px-14 sm:px-10 text-white text-justify leading-9 font-normal">
            ...
            Part science-fiction, part fantasy. CRYPTIDS is a generative art project of 7,777 fantastic mythical creatures with hundreds of unique attributes. 
          ...
          <p className="flex flex-row justify-start selection:bg-cryptid-2 selection:text-gray-800 lg:px-44 md:px-14 sm:px-10 text-white text-justify leading-9 font-normal pb-10">
            ...
            their creative talents to create something awesome. They asked themselves: What do we think is cool?
            What do we want to share with the world? What hasn’t been done before?
            <br></br>
            <br></br>
