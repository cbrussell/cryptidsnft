...
export default function MyApp() {
  ...
  return (
    <div id="team">
      <div className="flex flex-col items-center justify-center sm:px-0 px-6 z-20 py-10   ">
            ...
            <ul className="flex justify-around items-center space-x-10 pt-1 md:pt-0  px-2 sm:px-3 " >
              ...
              <li>
                <a href="https://medium.com/@TetraTeras" target="_blank" rel="noreferrer">
                  ...
                  >
                    <path xmlns="http://www.w3.org/2000/svg" d="M125 173c0-4-2-9-5-11l-31-38v-6h98l75 166 67-166h93v6l-27 26c-2 1-3 4-3 7v190c0 3 1 6 3 8l27 25v6H289v-6l27-26c3-3 3-4 3-8V193l-76 192h-10l-88-192v129c-1 5 1 11 5 15l35 43v5H85v-5l35-43c4-4 6-10 5-15z"/>
