              ...
              <div className="py-8 space-y-4 text-base leading-6 text-gray-700 sm:text-lg sm:leading-7">
                <ul className="space-y-2 list-disc">
                  <li className="flex items-start">
                    ...
                    <p className="ml-2">
                      <code className="font-semibold text-gray-900">11,111</code>{" "}
                      Total Supply
                    </p>
                  </li>
                  <li className="flex items-start">
                    ...
                    <p className="ml-2">
                      Meet Cryptids - The Adminstrators of the Metaverse. 
                    </p>
                  </li>
                  <li className="flex items-start">
                    <span className="flex items-center h-6 sm:h-7">
                    ...
                    <p className="ml-2">
                      Six animal bases with up to twelve unique fetures in nine different colors. 
                    </p>
                  </li>
                  <li className="flex items-start">
                    <span className="flex items-center h-6 sm:h-7">
                    ...
                    <p className="ml-2">0.111 ETH per CRYPITD.</p>
                  </li>
                </ul>
              </div>
